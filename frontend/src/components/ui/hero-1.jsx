...
const Hero1 = () => {
  return (
    <div
      className="min-h-[26rem] bg-[#0c0414] text-white flex flex-col relative overflow-x-hidden">
      {/* Gradient */}
      <div
      ...
      <header className="flex justify-between items-center p-6">
        <div className="flex items-center gap-2">
          ...
          <div className="font-bold text-md">Receipt AI</div>
        </div>
        <button
      ...
      <main
        ...
        <div className="max-w-4xl mx-auto space-y-6">
          <div className="flex-1 flex justify-center">
            <div
              className="bg-[#1c1528] rounded-full px-4 py-2 flex items-center gap-2  w-fit mx-4">
          ...
          <h1 className="text-4xl sm:text-5xl font-bold leading-tight">
            Extract receipt data and ask better questions
          </h1>

          {/* Subtitle */}
          <p className="text-md">
            Upload once, get structured fields, then query the document in natural language.
          </p>
          ...
          <div className="relative max-w-2xl mx-auto w-full">
            <div className="bg-[#1c1528] rounded-full p-3 flex items-center">
              ...
              <input
                type="text"
                placeholder="Try: What is the total amount?"
          ...
          <div className="flex flex-wrap justify-center gap-2 mt-12 max-w-2xl mx-auto">
            ...
            <button
              className="bg-[#1c1528] hover:bg-[#2a1f3d] rounded-full px-4 py-2 text-sm">
              Fallback to LLM when unsure
            </button>
            <button
              className="bg-[#1c1528] hover:bg-[#2a1f3d] rounded-full px-4 py-2 text-sm">
              Ask questions from extracted JSON
            </button>
            <button
              className="bg-[#1c1528] hover:bg-[#2a1f3d] rounded-full px-4 py-2 text-sm">
              FastAPI + React workflow
            </button>
          </div>
        </div>
      </main>
